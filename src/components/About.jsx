          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-gray-700 mb-6">
                I'm a passionate frontend developer. I specialize in React,
                TypeScript, and modern CSS frameworks to build scalable,
                performant applications.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                My journey started with a curiousity for how website work, and
                it has envolved into love for crafting pixel-perfect interfaces
